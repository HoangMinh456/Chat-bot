...
const SideBar = () => {
    ...
    return (
        <div className={`Side-bar bg-[#202123] text-white transition-all duration-200 transform max-md:absolute max-md:w-[70%] select-none z-10 ${openMenu === 'open' ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
